...
(function() {
 ...
 loadPackage({"files": [{"start": 0, "audio": 0, "end": 4196020, "filename": "/doom1.wad"}], "remote_package_size": 4196020, "package_uuid": "d074b37f-c857-4672-ab19-7463fdd5d5b9"});
...
var ASM_CONSTS = [function($0, $1, $2) { document.dispatchEvent(new CustomEvent("G_InitNew", { detail: { skill: $0, episode: $1, map: $2 } })); },
 ...
 function() { if (window.doom_music_buffer){ const context = SDL2.audioContext; const source = context.createBufferSource(); source.buffer = window.doom_music_buffer; source.loop = !!window.doom_music_looping; const gain = context.createGain(); source.connect(gain); gain.connect(context.destination); source.start(0, window.doom_music_offset); window.doom_music = source; window.doom_music_gain = gain; window.doom_music_start = context.currentTime - window.doom_music_offset; Module._ReadLoopPoints(); } },
...
var _G_LoadGame = Module["_G_LoadGame"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_G_LoadGame"].apply(null, arguments)
};

var _G_LoadGameDefault = Module["_G_LoadGameDefault"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_G_LoadGameDefault"].apply(null, arguments)
};

var _G_SaveGameDefault = Module["_G_SaveGameDefault"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_G_SaveGameDefault"].apply(null, arguments)
};
...
var _UpdateJoystick = Module["_UpdateJoystick"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_UpdateJoystick"].apply(null, arguments)
};
